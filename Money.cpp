...
double Money::get_sum1(Money& a) {
    return (a.g500 * 500. + a.g200 * 200. + a.g100 * 100. + a.g50 * 50. +
...
double Money::get_sum2(Money& b) {
    return (b.g500 * 500. + b.g200 * 200. + b.g100 * 100. + b.g50 * 50. +
...
{
    Money x;
    double minus = get_sum1(a) - get_sum2(b);
    /*if (minus < 0) {
        cerr << "Sum 1 < Sum2"<<endl;
        x.Init(a.g500, a.g200, a.g100, a.g50, a.g20, a.g10, a.g5, a.g2, a.g1, a.c50, a.c25, a.c10, a.c5, a.c2, a.c1);
    }
    else {*/
        double z = minus;
        double frac = 0;
